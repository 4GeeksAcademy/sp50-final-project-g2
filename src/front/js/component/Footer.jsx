	...
	<footer className="bd-footer p-0 bg-body-tertiary Footer" >
		<div className="text-center" style={{ backgroundColor: '#f8de6c' }}>
    		<ul className="list-unstyled small m-0" >
    		  ...
    		  <li className=" pb-3 m-0">Por cualquier consulta, puedes contactarnos <a href="mailto:example@gmail.com?Subject=Consulta" target="_blank" rel="license noopener">aquí.</a></li>
			  <li className=" pb-2 m-0"> <strong>© 2024 Copyright</strong> </li>
    		</ul>
    	</div>
