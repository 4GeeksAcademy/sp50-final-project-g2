...
export const ProfileCompany = () => {
    ...
    return (
        <div>
            ...
            <div className="d-grid col-9 m-2 mt-3 mb-3 background_form rounded justify-content-center" style={{border: "solid", borderColor: "#FFC66B"}}>
